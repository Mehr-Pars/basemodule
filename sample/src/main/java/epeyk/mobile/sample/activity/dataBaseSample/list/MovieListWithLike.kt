...
import epeyk.mobile.sample.CustomLoadMoreView
import epeyk.mobile.sample.R
import epeyk.mobile.sample.activity.movieDetail.MovieDetailActivity
import epeyk.mobile.sample.adapter.AdapterMovieListWithLike
import epeyk.mobile.sample.api.MovieListModel
import epeyk.mobile.sample.databinding.ActivityMovieListWithLikeBinding
import epeyk.mobile.sample.db.model.MovieLikeModelDB
